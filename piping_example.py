...
p = sp.Popen(["python","communities_CK_one_network_with_main.py"],stdin=sp.PIPE, stdout=sp.PIPE)  #le mando ejecutar otro programa 
...
G= nx.read_edgelist(network_file_name)
