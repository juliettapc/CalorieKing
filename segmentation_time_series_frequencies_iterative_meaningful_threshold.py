...
#input file:
        ...
        file_name_hist="temporal_series/most_weigh_ins/histogram_frequencies_indiv_top50_"+str(index_file)+"_threshold.dat"        
    ...
    file_name_hist="temporal_series/most_weigh_ins/histogram_frequencies_top50_"+str(top)+"_threshold.dat"        
    ...
    file_name_hist="temporal_series/most_weigh_ins/histogram_frequencies_not_averaged50_threshold.dat"        
