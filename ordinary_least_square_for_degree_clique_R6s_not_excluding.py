...
def main(graph_name):
    ...
    name1=name1+"_values_weigh_change_users_degree_clique_R6s_not_excluding.csv"           
    file=open(name1, 'wt')
   
    print >> file,'label','pwc','act','log_act','wi','wi/12','ibmi','sqrt_ibmi','R6','R6_2','k','log_k','cs','cs_2',"t","naw"
