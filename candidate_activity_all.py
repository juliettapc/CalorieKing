...
def get_activity_history(uid, db, year_restrict=None):
    ...
    q = "SELECT activity_date, activity_flag,on_day FROM activity_combined, weigh_in_history WHERE ck_id = '"+uid+"'"   
