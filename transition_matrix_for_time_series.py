...
################################
            ...
            for line in list_lines_file:           
                ...
                if trend == "exp":               
                    ...
                    if coef1_exp <= max_coef and coef1_exp >= -max_coef : 
                        if coef2_exp <= max_coef and coef2_exp >= -max_coef : 
                            if coef3_exp <= max_coef and coef3_exp >= -max_coef : 

                                length=float(list_one_line[4])
                                state=trend+"_"+str(coef2_exp)+"_"+str(coef3_exp)#+"_"+str(coef3_exp)
                    ...
                    if coef1_lin <= max_coef and coef1_lin >= -max_coef : 
                        if coef2_lin <= max_coef and coef2_lin >= -max_coef : 

                            state=trend+"_"+str(coef2_lin)#+"_"+str(coef2_lin)
                            if state not in list_diff_states:
                                list_diff_states.append(state)
