...
def main(iteracion):   # archivo de salida

     file1 = open('rand_summary_modularity_analysis'+str(iteracion),'wt') # one summary file for everything    
    ...
    #name_list.append(str(scale)+'_points_network/data/friend_graph_all0')
          ...
          name_list.append('randomized_network'+str(iteracion)) #archivo de entrada
...
# write the output files  
          ...
          file2 = open('rand_list_modularity_analysis'+str(iteracion),'wt') #one output file per each input file
          ...
          file1 = open('rand_summary_modularity_analysis'+str(iteracion),'at') # one summary file for everything
