...
file1 = open('rand_summary_modularity_analysis','wt') # one summary file for everything

print >> file1, "data: N  <k>  k(hub)  modularity  #_communities  <community_size>  max_community_size\n"  
...
for scale in scale_list:
    ...
    #name_list.append(str(scale)+'_points_network/data/friend_graph_all0')
     name_list.append('randomized_network')
...
# write the output files  
    ...
    file2 = open('rand_list_modularity_analysis','wt') #one output file per each input file
    ...
    file1 = open('rand_summary_modularity_analysis','at') # one summary file for everything
