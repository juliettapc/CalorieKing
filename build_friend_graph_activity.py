...
class CKGraph(object):
    ...
    def build_undirected_graph(self, duration=None, uids=None):
        ...
        for i in range(len(graphs)):
            nx.write_edgelist(graphs[i], "/home/staff/rmukogo/calorie_king_hg/10_points_network/data/new_networks/friends_undirected_all"+g_tag+str(i), data=False)
            nx.write_gml(graphs[i],"/home/staff/rmukogo/calorie_king_hg/10_points_network/data/new_networks/friends_undirected_all"+g_tag+str(i)+".gml")
        return graphs
