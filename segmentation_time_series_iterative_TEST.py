...
def main ():
    ...
    min_lenght=20  # to cut the series


    for index_file in range(1):
        index_file+=1

        file_name="temporal_series/most_weigh_ins/test_time_series_t_points_amplitude1.0_deltaY1.0.dat"
        ...
        file2=open(file_name.split(".dat")[0]+"_t_points_segments"+str(min_lenght)+".dat",'wt')
        ...
        for list_evolution in list_series:  # i analyze the current time serie (or fragment of it)
            ...
            if num_points>=min_lenght:  # if the serie is too short, i wont cut it any further
                ...
                if significance_t_max>significance_threshold :
                    ...
                    print "    file:",index_file,"cut at max_t:", t_max, "non significant!",significance_t_max,"           I:",I,"eta:",eta,"nu:",nu,"x:",x,"a:",a,"N:",num_points#at time:",list_evolution[index_max_t][0],"non significant!",I
                    


        
        list_cut_times=sorted(list_cut_times)
        print list_cut_times
        cut_inferior=0.0
            ...
            for cut in list_cut_times:
                ...
                for vector in list_vectors:
                    ...
                    if vector[0]>= cut_inferior and vector[0]<= cut:
                        print cut_inferior, cut,vector[0],vector[1],vector[2]
                ...
                if cut == list_cut_times[-1]:
                    for vector in list_vectors:
                        if vector[0]>= cut:                        
                            print >> file2, vector[0],vector[1],vector[2]
                            print cut,vector[0],vector[1],vector[2]
