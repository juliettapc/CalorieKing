...
def main ():
    ...
    for index_file in range(50):
        ...
        for list_evolution in list_series:  # i analyze the current time serie (or fragment of it)  
            ...
            print "length current list",len(list_evolution)
            if (int(list_evolution[-1][0])-int(list_evolution[0][0]))  >= min_num_days   and int(len(list_evolution)) >= min_num_points:
         ...
         #   print >> file1, "\n" # to separate segments 
                ...
                if len(list_rest_serie)>=min_num_days and  index_min_MSER>=min_num_days:  # i only allow to cut a serie down to a segment of 20 points
        ...
        print "     # segments:",len(list_cutting_times)+1,"--", list_cutting_times, evolution[-1][0]
        ...
        if len(list_cutting_times)!=0:
            ...
            for cut in list_cutting_times:
                ...
                for point in  evolution:   # original list of evolution : [[time1,value1],[time2,value2],[],...]
