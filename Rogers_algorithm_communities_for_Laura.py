...
def main(input_file_name):
    ...
    G=components[0]   # i take only the giant component


  

    edgelist_file_name=input_file_name.split(".gml")[0]  # write a simple edgelist because that
    nx.write_edgelist(G, edgelist_file_name, data=False)   # is what Roger's code actually uses




    file1 = open(edgelist_file_name +'_modularity_analysis_GC','wt') # i create one summary file for everything
