...
def main():
    ...
    for r1 in result1:
        ...
        if prior2009 =="NO":
            ...
            dict_master_user_info[ck_id]['most_recent_weight']=r1['most_recent_weight']
    ...
    print "tot num. friendships",num_friendships,len(G.edges()), " among:",len(G.nodes()),len(list_networked_labels)
