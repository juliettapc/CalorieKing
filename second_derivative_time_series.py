...
def main ():
    ...
    for index_file in range(50):
        ...
        file_name="temporal_series/most_weigh_ins/weigh_in_time_serie_days"+str(index_file)+"_top50_derivative_pwc"  # to get the 2ND derivative
        new_name=file_name.split("derivative")[0]
        ...
        #print line: index  weight  %weight_ch  BMI  days
            ...
            if True:             #for the 2nd derivative
